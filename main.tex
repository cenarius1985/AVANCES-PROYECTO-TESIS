...
\title{
    ...
    \large{Metodología de adquisición y procesamiento de imágenes de tiempo de eco ultra corto (UTE) en resonancia magnética de bajo campo: aplicación en hueso cortical.}
}
\author{
