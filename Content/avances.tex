...
\begin{itemize}
    ...
    \item \textbf{Artefactos de Movimiento:} Minimización del impacto del tiempo de adquisición en la calidad de imagen mediante el algoritmo Enhanced Correlation Coefficient (ECC).
\end{itemize}
