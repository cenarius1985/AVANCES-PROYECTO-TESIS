...
\begin{itemize}
    ...
    \item \textbf{Artefactos de Movimiento:} Minimización del impacto del tiempo de adquisición (aprox. 54 min) en la calidad de imagen mediante el algoritmo Enhanced Correlation Coefficient (ECC).
\end{itemize}

\subsection{Producción Científica}
Actualmente se trabaja en el manuscrito \textit{"Bi-Component Quantification of Cortical Bone Water Fractions Using Low-Field UTE MRI: Comparison with BDAT Ultrasound"}, con objetivo de publicar el estudio tiene un 30\% de avances.
