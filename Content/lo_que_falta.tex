...
\begin{itemize}
    ...
    \item \textbf{Escritura y Revisión de Manuscritos:} Finalizar la redacción del artícul para busqueda de publicación científica y la integración de capítulos en el documento final de tesis.
    \item \textbf{Trámites Administrativos de Defensa:} Cumplir con los plazos de defensa pública establecidos por el programa de doctorado de la Universidad de Valparaíso para el segundo semestre de 2026.
\end{itemize}
